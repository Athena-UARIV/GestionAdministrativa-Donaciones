...
require_once("include/alasientos_gestion_t_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "alasientos_gestion_t" );
