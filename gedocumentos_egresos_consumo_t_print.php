...
require_once("include/gedocumentos_egresos_consumo_t_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "gedocumentos_egresos_consumo_t" );
