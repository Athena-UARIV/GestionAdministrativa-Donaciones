...
require_once("include/tparam_direcc_territoriales_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tparam_direcc_territoriales" );
